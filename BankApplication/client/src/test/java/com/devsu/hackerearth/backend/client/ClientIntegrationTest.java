...
public class ClientIntegrationTest {
    ...
    void getClientById_ShouldHandleClientWithNullOptionalFields() throws Exception {
        // Arrange - Cliente con campos opcionales nulos
        ...
        minimalClient.setAge(0); // Age mínimo
        minimalClient.setAddress(null); // Campo opcional
        minimalClient.setPhone(null); // Campo opcional
